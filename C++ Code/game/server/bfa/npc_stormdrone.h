...
#ifndef NPC_STORMDRONE_H
#define NPC_STORMDRONE_H
#ifdef _WIN32
#pragma once
#endif
...
#define SF_STORMDRONE_PACKED_UP			(1 << 16)
#define SF_STORMDRONE_NO_DAMAGE_EFFECTS	(1 << 17)
#define SF_STORMDRONE_USE_AIR_NODES		(1 << 18)
#define SF_STORMDRONE_CARRIED				(1 << 19)	// Being carried by a metrocop
#define SF_STORMDRONE_NO_DANGER_SOUNDS		(1 << 20)

enum
{
	STORMDRONE_EYE_STATE_IDLE,
	STORMDRONE_EYE_STATE_CHASE,
	STORMDRONE_EYE_STATE_CHARGE,
	STORMDRONE_EYE_STATE_STUNNED,
};

//-----------------------------------------------------------------------------
// Attachment points.
//-----------------------------------------------------------------------------
#define	STORMDRONE_GIB_HEALTH				30
#define	STORMDRONE_INACTIVE_HEALTH			25
#define	STORMDRONE_MAX_SPEED				500
#define STORMDRONE_BURST_SPEED				650
#define STORMDRONE_NPC_BURST_SPEED			800

//-----------------------------------------------------------------------------
// Movement parameters.
//-----------------------------------------------------------------------------
#define STORMDRONE_WAYPOINT_DISTANCE		25	// Distance from waypoint that counts as arrival.
...
// Manhack 
//-----------------------------------------------------------------------------
class CNPC_STORMDRONE : public CNPCBaseInteractive<CAI_BasePhysicsFlyingBot>, public CDefaultPlayerPickupVPhysics
{
DECLARE_CLASS( CNPC_STORMDRONE, CNPCBaseInteractive<CAI_BasePhysicsFlyingBot> );
DECLARE_SERVERCLASS();
