...
IMPLEMENT_CLIENTCLASS_DT(C_PropVehicleStormDrone, DT_PropVehicleStormDrone, CPropVehicleStormDrone)
...
BEGIN_DATADESC( C_PropVehicleStormDrone )
...
// Purpose: 
//-----------------------------------------------------------------------------
C_PropVehicleStormDrone::C_PropVehicleStormDrone( void )
{
...
// Input  : updateType - 
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::PreDataUpdate( DataUpdateType_t updateType )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::PostDataUpdate( DataUpdateType_t updateType )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
C_BaseCombatCharacter *C_PropVehicleStormDrone::GetPassenger( int nRole )
{
...
//-----------------------------------------------------------------------------
int	C_PropVehicleStormDrone::GetPassengerRole( C_BaseCombatCharacter *pPassenger )
{
...
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::GetVehicleViewPosition( int nRole, Vector *pAbsOrigin, QAngle *pAbsAngles, float *pFOV )
{
	//c_prop_vehicle.cpp
...
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::DampenEyePosition( Vector &vecVehicleEyePos, QAngle &vecVehicleEyeAngles )
{
...
// Purpose:
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::DampenForwardMotion( Vector &vecVehicleEyePos, QAngle &vecVehicleEyeAngles, float flFrameTime )
{
...
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::ComputePDControllerCoefficients( float *pCoefficientsOut,
...
// Purpose: 
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::OnEnteredVehicle( C_BasePlayer *pPlayer )
{
...
//			pCmd - 
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::UpdateViewAngles( C_BasePlayer *pLocalPlayer, CUserCmd *pCmd )
{
...
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::GetVehicleClipPlanes( float &flZNear, float &flZFar ) const
{
...
//-----------------------------------------------------------------------------
void C_PropVehicleStormDrone::DrawHudElements( )
{
	HLSS_DrawTargetHud(m_vecManhackEye, m_hPlayer, m_hTarget, m_iTargetType);
}

int C_PropVehicleStormDrone::GetPrimaryAmmoType() const
{
...
int C_PropVehicleStormDrone::GetPrimaryAmmoCount() const
{ 
	return m_iManhackHealth; 
}

int C_PropVehicleStormDrone::GetPrimaryAmmoClip() const
{ 
	return m_iManhackDistance; 
}

void C_PropVehicleStormDrone::ClientThink()
{
	if ( m_CCHandle == INVALID_CLIENT_CCHANDLE )
		return;
...
// Output  :
//------------------------------------------------------------------------------
void C_PropVehicleStormDrone::OnDataChanged(DataUpdateType_t updateType)
{
...
void C_PropVehicleStormDrone::UpdateOnRemove( void )
{
	if (m_CCHandle != INVALID_CLIENT_CCHANDLE)
	{
		g_pColorCorrectionMgr->SetColorCorrectionWeight( m_CCHandle, 0.0f );
